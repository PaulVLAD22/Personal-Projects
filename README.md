...
<h3>The others : </h3>
<h4><li>Coronavirus Mobile Tracker<i>(Java squareup, json)</i></h4> - Very simple app , enter the name of a country and it will tell you , using an api (found on rapidapi.com,which doesn't have information about certain countries) how many cases have there been in the last 24h ,and other info. 
Made in Android Studio, in Java, using squareup.http and org.json.
