...
<h3>The others : </h3>
<h4><li>Spaceships style game</h4>(Python Pygame) - A simple game very similar to "Space Invaders" in which the player is a rocket that shoots aliens that destroy on touch(it also has Score and Percentage of hit shots).<br>
